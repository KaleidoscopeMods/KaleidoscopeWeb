...
export const itemMetaMap: Partial<Record<CanonicalItemName, ItemMeta>> = {
  ...
  'kaleidoscope_doll:computer': { name: { zhCN: '电脑' } },
  'kaleidoscope_doll:custom_doll': { name: { zhCN: '自定义玩偶' } },
  'kaleidoscope_doll:doll_entity_item': { name: { zhCN: '玩偶（实体物品）' } },
  'kaleidoscope_doll:doll_icon': { name: { zhCN: '森罗玩偶' } },
  'kaleidoscope_doll:doll_machine': { name: { zhCN: '玩偶抽奖机' } },
  'kaleidoscope_doll:green_doll_gift_box': { name: { zhCN: '绿色礼品盲盒' } },
  'kaleidoscope_doll:purple_doll_gift_box': { name: { zhCN: '紫色礼品盲盒' } },
  'kaleidoscope_doll:yellow_doll_gift_box': { name: { zhCN: '黄色礼品盲盒' } },
  'kaleidoscope_doll:tweaks_tool': { name: { zhCN: '指指点点' } },
  'kaleidoscope_doll:doll_0': { name: { zhCN: '玩偶 doll_0（作者：药水棒冰）' } },
  'kaleidoscope_doll:doll_1': { name: { zhCN: '玩偶 doll_1（作者：酒石酸菌）' } },
  'kaleidoscope_doll:doll_2': { name: { zhCN: '玩偶 doll_2' } },
  'kaleidoscope_doll:doll_3': { name: { zhCN: '玩偶 doll_3' } },
  'kaleidoscope_doll:doll_4': { name: { zhCN: '玩偶 doll_4' } },
  'kaleidoscope_doll:doll_5': { name: { zhCN: '玩偶 doll_5' } },
  'kaleidoscope_doll:doll_6': { name: { zhCN: '玩偶 doll_6' } },
  'kaleidoscope_doll:doll_7': { name: { zhCN: '玩偶 doll_7' } },
  'kaleidoscope_doll:doll_8': { name: { zhCN: '玩偶 doll_8' } },
  'kaleidoscope_doll:doll_9': { name: { zhCN: '玩偶 doll_9' } },
  'kaleidoscope_doll:doll_10': { name: { zhCN: '玩偶 doll_10' } },
  'kaleidoscope_doll:doll_11': { name: { zhCN: '玩偶 doll_11' } },
  'kaleidoscope_doll:doll_12': { name: { zhCN: '玩偶 doll_12' } },
  'kaleidoscope_doll:doll_13': { name: { zhCN: '玩偶 doll_13' } },
  'kaleidoscope_doll:doll_14': { name: { zhCN: '玩偶 doll_14' } },
  'kaleidoscope_doll:doll_15': { name: { zhCN: '玩偶 doll_15' } },
  'kaleidoscope_doll:doll_16': { name: { zhCN: '玩偶 doll_16' } },
  'kaleidoscope_doll:doll_17': { name: { zhCN: '玩偶 doll_17' } },
  'kaleidoscope_doll:doll_21': { name: { zhCN: '玩偶 doll_21' } },
  'kaleidoscope_doll:doll_34': { name: { zhCN: '玩偶 doll_34' } },
  'kaleidoscope_doll:doll_35': { name: { zhCN: '玩偶 doll_35' } },
  'kaleidoscope_doll:doll_52': { name: { zhCN: '玩偶 doll_52' } },
  'kaleidoscope_doll:doll_66': { name: { zhCN: '玩偶 doll_66' } },
  'kaleidoscope_doll:doll_67': { name: { zhCN: '玩偶 doll_67（作者：Abert_Cat）' } },
  'kaleidoscope_doll:doll_68': { name: { zhCN: '玩偶 doll_68（作者：CR_019）' } },
  'kaleidoscope_doll:doll_326': { name: { zhCN: '玩偶 doll_326' } },
  'kaleidoscope_doll:doll_327': { name: { zhCN: '玩偶 doll_327' } },
  'kaleidoscope_doll:doll_328': { name: { zhCN: '玩偶 doll_328（酒狐）' } },
  'kaleidoscope_doll:doll_329': { name: { zhCN: '玩偶 doll_329（萌化生物：坚守者）' } },
  'kaleidoscope_doll:doll_599': { name: { zhCN: '玩偶 doll_599（作者：冰镇大西瓜）' } },
  'kaleidoscope_doll:doll_601': { name: { zhCN: '玩偶 doll_601（作者：银川安）' } },
  'kaleidoscope_doll:doll_614': { name: { zhCN: '玩偶 doll_614（作者：GRAINALCOHOL）' } },
  'kaleidoscope_doll:doll_690': { name: { zhCN: '玩偶 doll_690（萌化生物：骷髅）' } },
  'kaleidoscope_doll:doll_691': { name: { zhCN: '玩偶 doll_691（萌化生物：苦力怕）' } },
  'kaleidoscope_doll:doll_692': { name: { zhCN: '玩偶 doll_692（作者：梦露鱼）' } },
  'minecraft:clay_ball': { name: { zhCN: '粘土球' } },
  'minecraft:diamond': { name: { zhCN: '钻石' } },
  'minecraft:gold_ingot': { name: { zhCN: '金锭' } },
  'minecraft:iron_ingot': { name: { zhCN: '铁锭' } },
  'minecraft:redstone': { name: { zhCN: '红石粉' } },
  'minecraft:slime_ball': { name: { zhCN: '黏液球' } },
  'minecraft:smooth_stone': { name: { zhCN: '平滑石' } },
  'minecraft:stick': { name: { zhCN: '木棍' } },
  'minecraft:white_wool': { name: { zhCN: '白色羊毛' } },
}
